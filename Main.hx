...
function main() {
    ...
    switch systemName {
        ...
        case "Linux":
            ...
            Sys.command("sudo apt-get install --no-install-recommends -y libpng-dev libturbojpeg-dev libvorbis-dev libopenal-dev libsdl2-dev libmbedtls-dev libuv1-dev");
