...
function Main_setupLinux() {
	var args = null;
	if(args == null) {
		js_node_ChildProcess.spawnSync("sudo apt-get update -qqy & sudo apt-get install -qqy libpng-dev libturbojpeg-dev libvorbis-dev libopenal-dev libsdl2-dev libmbedtls-dev libuv1-dev",{ shell : true, stdio : "inherit"});
	} else {
		js_node_ChildProcess.spawnSync("sudo apt-get update -qqy & sudo apt-get install -qqy libpng-dev libturbojpeg-dev libvorbis-dev libopenal-dev libsdl2-dev libmbedtls-dev libuv1-dev",args,{ stdio : "inherit"});
	}
	var args = null;
	if(args == null) {
	...
	var args = null;
	if(args == null) {
		js_node_ChildProcess.spawnSync("cd hashlink",{ shell : true, stdio : "inherit"});
	} else {
		js_node_ChildProcess.spawnSync("cd hashlink",args,{ stdio : "inherit"});
	}
	var args = null;
	if(args == null) {
		js_node_ChildProcess.spawnSync("make install",{ shell : true, stdio : "inherit"});
	} else {
		js_node_ChildProcess.spawnSync("make install",args,{ stdio : "inherit"});
	}
